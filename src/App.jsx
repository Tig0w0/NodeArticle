...
const editableRoles=['LEAD','FACT','IMAGE','QUOTE','CONTEXT','OUTLOOK']
...
export default function App(){
 ...
 const changeRole=role=>setArticles(a=>a.map(n=>n.id===current.id?{...n,data:{...n.data,role,kind:role==='IMAGE'?'image':undefined}}:n))
